...
import type { PaginationProps } from '@/lib/types/admin';

/**
 * RckikPagination - Komponent paginacji dla listy centrów RCKiK
 *
 * Extended version z dodatkowymi features:
 * - Informacja o wynikach (Wyświetlanie 1-20 z 45 centrów)
 ...
 */
export function RckikPagination({
  currentPage,
  totalPages,
  pageSize,
  totalElements,
  ...
  // Helper dla liczby centrów (gramatyka polska)
  const getCentrumsText = (count: number): string => {
    ...
    <div className="bg-white border-t border-gray-200 px-4 py-4 sm:px-6">
      ...
      <div className="flex flex-col gap-4 sm:hidden">
        ...
        <div className="text-sm text-gray-700 text-center">
          ...
          <span className="font-medium">{totalElements}</span> {getCentrumsText(totalElements)}
        </div>
