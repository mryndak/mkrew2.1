...
/**
 * DTO for detailed scraper run information with logs
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Detailed scraper run information with logs")
public class ScraperRunDetailsDto {
    ...
    @Schema(description = "List of scraper logs for this run")
    private List<ScraperLogDto> logs;
}
